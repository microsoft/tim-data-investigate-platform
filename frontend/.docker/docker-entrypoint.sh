...
envsubst '\$AUTH_CLIENT_ID \$AUTH_TENANT_ID \$REDIRECT_URI \$BACKEND_URI \$API_BASEPATH \$AGGRID_LICENSE \$KUSTO_CLUSTER_URI \$KUSTO_DATABASE_NAME \$HELP_HOME_URI \$HELP_WIKI_URI \$HELP_ISSUE_URI \$HELP_FEATURE_URI' < /config.js.envsubst > /usr/share/nginx/html/config.js
