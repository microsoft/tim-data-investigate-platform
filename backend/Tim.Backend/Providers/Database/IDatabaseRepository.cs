...
namespace Tim.Backend.Providers.Database
{
        ...
        where TJsonEntity : IJsonEntity
    {
        ...
        public Task<TJsonEntity> AddOrUpdateItem(string id, IJsonEntity entity);
